...
def valid_search_location_old():
    return "https://api.github.com/repos/Manbeardo/MTGA_Draft_17Lands/releases/96565628"

@pytest.fixture
def valid_search_location_latest():
    return "https://api.github.com/repos/Manbeardo/MTGA_Draft_17Lands/releases/latest"
...
def valid_input_url_zip():
    return "https://github.com/Manbeardo/MTGA_Draft_17Lands/releases/download/MTGA_Draft_Tool_V0307/MTGA_Draft_Tool_V0307_Setup.zip"
    
@pytest.fixture
def valid_input_url_exe():
    return "https://github.com/Manbeardo/MTGA_Draft_17Lands/releases/download/MTGA_Draft_Tool_V0304/MTGA_Draft_Tool_V0304_Setup.exe"
