...
from src.overlay import (
    ...
    copy_taken,
    fixed_map,
    identify_card_row_tag,
    identify_safe_coordinates,
    identify_table_row_tag,
    logger,
    toggle_widget,
    url_callback,
)
...
class Overlay(ScaledWindow):
    ...
    def __init__(self, args):
        ...
        self.datamenu.add_command(label="Add Sets", command=self.__open_set_view_window)
        ...
        self.refresh_button = Button(
            ...
            command=lambda: self.__update_overlay_callback(True),
            text="Refresh",
        )
    ...
    def __update_pack_table(self, card_list, filtered_colors, fields):
        ...
        try:
            ...
            if self.table_info["pack_table"].column in visible_columns:
                ...
                result_list = sorted(
                    result_list,
                    key=lambda d: CL.field_process_sort(d["results"][column_index]),
                    reverse=direction,
                )
            else:
                result_list = sorted(
                    result_list,
                    key=lambda d: CL.field_process_sort(d["results"][last_field_index]),
                    reverse=True,
                )
            ...
            if not missing_cards:
                ...
                if list_length:
                    ...
                    if self.table_info["missing_table"].column in visible_columns:
                        ...
                        result_list = sorted(
                            result_list,
                            key=lambda d: CL.field_process_sort(
    ...
    def __update_compare_table(self, entry_box=None):
        ...
        try:
            ...
            card_list = (
                self.draft.set_data["card_ratings"] if self.draft.set_data else []
            )
        ...
        try:
            ...
            for count, card in enumerate(suggested_deck):
                ...
                if constants.CARD_TYPE_LAND in card[constants.DATA_FIELD_TYPES]:
                    ...
                    card_colors = "".join(
                        list(
                            CL.card_colors(card[constants.DATA_FIELD_MANA_COST]).keys()
                        )
    ...
    def __update_draft(self):
        ...
        if self.draft.draft_start_search():
            ...
            self.__update_draft_data()
            logger.info(
                "%s, Mean: %.2f, Standard Deviation: %.2f",
    ...
    def __open_set_view_window(self):
        ...
        try:
            ...
            headers = {
                "SET": {"width": 0.40, "anchor": tkinter.W},
                "DRAFT": {"width": 0.20, "anchor": tkinter.CENTER},
    ...
    def __open_card_compare_window(self):
        ...
        try:
            ...
            card_entry = AutocompleteEntry(card_frame, completevalues=set_card_names)
    ...
    def __open_settings_window(self):
        ...
        try:
            ...
            bayesian_average_label = Label(
                popup,
                text="Enable Bayesian Average:",
                style="MainSectionsBold.TLabel",
                anchor="e",
            )
            bayesian_average_checkbox = Checkbutton(
                popup,
    ...
    def __open_about_window(self):
        ...
        try:
            ...
            github_url = Label(
                popup,
                text="https://github.com/Manbeardo/MTGA_Draft_17Lands",
                style="MainSections.TLabel",
                anchor="c",
                foreground="#0066CC",
                cursor="hand2",
                            ...
                            for k in color_dict[color]:
                                if (
                                    ...
                                    if k in constants.WIN_RATE_FIELDS_DICT:
                                        ...
                                        color_dict[color][k] = CL.calculate_win_rate(
    ...
    def __control_trace(self, enabled):
        ...
        try:
            trace_list = [
                ...
                (
                    self.bayesian_average_checkbox_value,
                    lambda: self.bayesian_average_checkbox_value.trace(
                        "w", self.__update_settings_callback
                    ),
                ),
                (
                    ...
                    if message_box:
                        ...
                        if output_location:
                            ...
                            message_box = tkinter.messagebox.showerror(
                                ...
                                message="Visit https://github.com/Manbeardo/MTGA_Draft_17Lands/releases to manually download the new version.",
                            )

                else:
                    message_string = f"Update {new_version} is now available.\n\nCheck https://github.com/Manbeardo/MTGA_Draft_17Lands/releases for more details."
